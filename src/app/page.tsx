        ...
        <div className="container relative z-10 mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                href="/tuning-guide"
                className="inline-flex items-center gap-2 px-8 py-4 border border-white/30 text-white text-sm font-bold tracking-widest uppercase hover:bg-white/10 hover:border-white/60 transition-all"
              >
                Explore Services
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-reveal-child>
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  href="/warport"
                  className="px-8 py-4 bg-[#FC222D] text-white text-sm font-black tracking-widest uppercase hover:bg-[#CC1B25] transition-colors flex items-center gap-2"
                >
                  Learn More <ChevronRight size={14} aria-hidden="true" />
                </Link>
                <Link
                  href="/contact"
                  className="px-8 py-4 border-2 border-black text-black text-sm font-black tracking-widest uppercase hover:bg-black hover:text-white transition-all"
                >
                  Free Pre-Approval
                </Link>
              </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-10 py-4 bg-[#25D366] text-white uppercase text-sm font-bold tracking-widest hover:bg-[#1ebe5d] transition-colors shadow-xl flex items-center gap-3"
            >
            ...
            <a
              href="tel:+61422300859"
              className="px-10 py-4 bg-black text-white uppercase text-sm font-bold tracking-widest hover:bg-[#111] transition-colors shadow-xl flex items-center gap-3"
            >
