...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Mercedes AMG tune",
    "Porsche ECU remap",
    "flex fuel tuning Australia",
    "E85 ethanol tune",
    "anti-lag Melbourne",
    "launch control tune",
    "boost by gear mapping",
    "remote ECU tuning Australia",
    "PTEB Warport",
    "stage 1 tune Melbourne",
    "stage 2 tune Melbourne",
    "B58 tune", "EA888 tune", "S55 tune",
    "performance tuning shop Melbourne",
  ],
  authors: [
...
const siteSchema = {
  ...
  "@graph": [
        ...
        itemListElement: [
          ...
          },
          {
            ...
            itemOffered: {
              ...
              description: "Remote OBD2 ECU tuning via the PTEB Warport device. Plug into your OBD port, connect via app, and PTEB tuners recalibrate your engine remotely. Available Australia-wide. Includes full custom calibration, live data logging, and ongoing revisions.",
              provider: { "@id": `${BASE_URL}/#business` },
    ...
    // ── Website entity ──────────────────────────────────────────────
    {
      ...
      name: "PTEB Tuning",
      url: BASE_URL,
      description: "Custom dyno tuning, ECU remapping, and performance calibration — Australia.",
    },
  ],
};
