...
const LINKS = {
  services: [
    ...
    { href: "/contact", label: "Book a Tune" },
  ],
  legal: [
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="lg:col-span-2">
          <div className="mb-4">
            ...
            <span
              className="block text-3xl font-extrabold tracking-tight text-[#FC222D]"
          ...
          <p className="text-sm leading-relaxed max-w-xs mb-6">
            Data-driven custom dyno tuning. Dyno-logged, road-perfected, and pushed to the limit —
            safely.
          </p>
        ...
        <div>
          ...
          <div className="mt-6 p-4 border border-[#FC222D]/30 bg-[#FC222D]/5">
      ...
      <div className="border-t border-[#1E1E1E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-[#4B5563]">
          <p>© {new Date().getFullYear()} PTEB Tuning. All rights reserved.</p>
          <p>
